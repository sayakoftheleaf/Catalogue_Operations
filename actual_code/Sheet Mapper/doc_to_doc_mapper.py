...
for iterRow in range(1, sourceRow + 1):
  ...
  for iterCol in range(1, sourceCol + 1):
    ...
    # FIXME: This will NOT work, because for Strings, you need the value,
    # for formulas, you need the internal value
    ...
    if colLetter in mapsTo:
      ...
      # TODO: here, you need to do some more processing
...
def main():
  ...
  sheetDir = input('Enter source file name: ')
  ...
  sheetDir = currentDir / 'Spreadsheets' / sheetDir
  ...
  sourceWorkbook = openpyxl.load_workbook(sheetDir)
